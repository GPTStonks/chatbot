...
const ChatbotCore = ({ messages, themeConfig, isMobile, botUser, humanUser, botMessage, messagesEndRef, isAnyMessageLoading, showLinearLoader, sendCustomMessage, welcomeMessageRenderFunction, botMessageRenderFunction, userMessageRenderFunction, dataRenderFunction, referenceRenderFunction, relatedQuestionsRenderFunction, }) => {
    ...
    const WelcomeMessageRender = (0, react_1.useCallback)((sendCustomMessage) => {
        return welcomeMessageRenderFunction ? (welcomeMessageRenderFunction(sendCustomMessage)) : (<material_1.Box sx={{
                position: 'fixed',
                width: '100vw',
                top: '50%',
                left: '50%',
    ...
    const BotMessageRender = (0, react_1.useCallback)((message, input) => {
        return botMessageRenderFunction ? (botMessageRenderFunction(message, input)) : (<material_1.Typography>{message.text}</material_1.Typography>);
    }, [botMessageRenderFunction]);
    const UserMessageRender = (0, react_1.useCallback)((text) => {
        return userMessageRenderFunction ? (userMessageRenderFunction(text)) : (<material_1.Typography variant="h4" sx={{
                overflow: 'hidden',
                display: '-webkit-box',
                WebkitLineClamp: 3,
    ...
    return (<material_1.Box sx={Object.assign({}, (_b = (_a = themeConfig.components) === null || _a === void 0 ? void 0 : _a.ChatBox) === null || _b === void 0 ? void 0 : _b.style)}>
      {messages.length === 0 && WelcomeMessageRender(sendCustomMessage)}
      <material_1.List>
        {messages.map((message, index) => {
            var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q, _r, _s, _t, _u, _v, _w, _x, _y, _z, _0, _1, _2, _3, _4, _5, _6, _7, _8, _9, _10, _11;
            return (<material_1.ListItem key={index} sx={{
                    display: 'flex',
            ...
            {!isMobile &&
                    ((((_d = (_c = themeConfig === null || themeConfig === void 0 ? void 0 : themeConfig.components) === null || _c === void 0 ? void 0 : _c.Avatar) === null || _d === void 0 ? void 0 : _d.showSideUserAvatar) &&
                        ...
                        (((_f = (_e = themeConfig === null || themeConfig === void 0 ? void 0 : themeConfig.components) === null || _e === void 0 ? void 0 : _e.Avatar) === null || _f === void 0 ? void 0 : _f.showSideBotAvatar) &&
                            message.user === botUser)) && (<material_1.Avatar // Side avatar (outside of message bubble)
            ...
            {isMobile &&
                    ((((_p = (_o = themeConfig === null || themeConfig === void 0 ? void 0 : themeConfig.components) === null || _o === void 0 ? void 0 : _o.Avatar) === null || _p === void 0 ? void 0 : _p.showSideUserAvatar) &&
                        ...
                        (((_r = (_q = themeConfig === null || themeConfig === void 0 ? void 0 : themeConfig.components) === null || _q === void 0 ? void 0 : _q.Avatar) === null || _r === void 0 ? void 0 : _r.showSideBotAvatar) &&
                            message.user === botUser)) && (<material_1.Avatar // Side avatar (outside of message bubble) for mobile
            ...
            {message.user === botUser ? (<material_1.Box sx={{
                        display: 'flex',
                ...
                {((_z = themeConfig.chatLayoutConfig) === null || _z === void 0 ? void 0 : _z.responseHeader) && (<material_1.Box sx={{
                            display: 'flex',
                            alignItems: 'center',
                            marginBottom: '1em',
                        }}>
                    <material_1.Avatar sx={Object.assign({}, (_1 = (_0 = themeConfig === null || themeConfig === void 0 ? void 0 : themeConfig.components) === null || _0 === void 0 ? void 0 : _0.Avatar) === null || _1 === void 0 ? void 0 : _1.style)} src={(_3 = (_2 = themeConfig === null || themeConfig === void 0 ? void 0 : themeConfig.components) === null || _2 === void 0 ? void 0 : _2.Avatar) === null || _3 === void 0 ? void 0 : _3.botAvatarUrl}/>
                    <material_1.Typography variant="h6" color={(_6 = (_5 = (_4 = themeConfig === null || themeConfig === void 0 ? void 0 : themeConfig.components) === null || _4 === void 0 ? void 0 : _4.MessageBubbleBot) === null || _5 === void 0 ? void 0 : _5.style) === null || _6 === void 0 ? void 0 : _6.color}>
                      {' '}
                      Response{' '}
                    </material_1.Typography>
                  </material_1.Box>)}

                <material_1.Box sx={Object.assign({ display: 'flex', flexDirection: 'column' }, (_8 = (_7 = themeConfig === null || themeConfig === void 0 ? void 0 : themeConfig.components) === null || _7 === void 0 ? void 0 : _7.MessageBubbleBot) === null || _8 === void 0 ? void 0 : _8.style)}>
                  <material_1.Box sx={{ display: 'flex' }}>
                    {message.text &&
                        (message.streamCompleted || !message.stream) &&
                        BotMessageRender(message, (_9 = messages[index - 1]) === null || _9 === void 0 ? void 0 : _9.text)}
                    {message.stream && (<material_1.Box sx={{
                            display: 'flex',
              ...
              </material_1.Box>) : (<material_1.Box sx={(_11 = (_10 = themeConfig === null || themeConfig === void 0 ? void 0 : themeConfig.components) === null || _10 === void 0 ? void 0 : _10.MessageBubbleUser) === null || _11 === void 0 ? void 0 : _11.style}>
                {UserMessageRender(message.text)}
              </material_1.Box>)}
          </material_1.ListItem>);
        })}
        {botMessage && isAnyMessageLoading && !showLinearLoader && (<material_1.ListItem sx={{
                display: 'flex',
                flexDirection: 'row',
            ...
            <material_1.Box sx={Object.assign({}, (_h = (_g = themeConfig === null || themeConfig === void 0 ? void 0 : themeConfig.components) === null || _g === void 0 ? void 0 : _g.LoaderBot) === null || _h === void 0 ? void 0 : _h.style)}>
              {/*TODO: Add a custom model_step loader*/}
              <react_loader_spinner_1.DNA visible={true} height="60" width="60" ariaLabel="dna-loading" wrapperStyle={{}} wrapperClass="dna-wrapper"/>
              <material_1.Typography sx={{
                ...
                {botMessage.text != 'world_knowledge' && botMessage.text != 'simple_reflection' && (<material_1.Typography> Preparing content from {botMessage.text}...</material_1.Typography>)}
              </material_1.Typography>
            </material_1.Box>
          </material_1.ListItem>)}
        {showLinearLoader && (<material_1.ListItem sx={{ display: 'flex', flexDirection: 'row', maxWidth: isMobile ? '70vw' : '40vw' }}>
