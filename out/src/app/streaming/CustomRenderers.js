...
exports.LoadingMessageRender =
  exports.ErrorRenderFunction =
  exports.ProviderRender =
  exports.SubqueryRender =
  exports.UserMessageRender =
  exports.BotMessageRender =
  exports.WelcomeMessageRender =
    void 0;
...
const WelcomeMessageRender = (sendCustomMessage) =>
...
const BotMessageRender = (message, input) =>
  react_1.default.createElement(
    material_1.Box,
    {
      sx: {
...
const SubqueryRender = (subqueryQuestion, subqueryResponse) =>
  react_1.default.createElement(
    material_1.Box,
    null,
...
const ProviderRender = (providers) =>
  react_1.default.createElement(
    material_1.Box,
    null,
...
const ErrorRenderFunction = (error) =>
  react_1.default.createElement(
    material_1.Box,
    {
      sx: {
          ...
          sx: Object.assign(
            ...
            (_m =
              (_l =
                ...
                ? void 0
                : _l.LoaderBot) === null || _m === void 0
              ? void 0
              : _m.style,
          ),
        },
        react_1.default.createElement(react_loader_spinner_1.MutatingDots, {
          visible: true,
          height: '60',
          width: '60',
          color: '#4fa94d',
          ...
          sx: Object.assign(
            ...
            (_t =
              (_s =
                themeConfig === null || themeConfig === void 0
                  ? void 0
                  : themeConfig.components) === null || _s === void 0
                ? void 0
                : _s.LoaderBot) === null || _t === void 0
              ? void 0
              : _t.style,
          ),
        },
