...
function Home() {
    ...
    return (react_1.default.createElement("main", { style: {
        ...
        react_1.default.createElement("div", { style: { width: '100%', height: '100%' } },
            react_1.default.createElement(ChatbotWebsocketStreaming_1.default, { multimodeChat: multimodeChat, multimodeRenderFunction: (modes) => (react_1.default.createElement(material_1.Box, { sx: {
                        display: 'flex',
                        justifyContent: 'center',
                        gap: '10px',
